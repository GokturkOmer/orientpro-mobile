class WorkOrder {
  ...
  String get statusText { switch (status) { case 'open': return 'Açık'; case 'assigned': return 'Atandi'; case 'in_progress': return 'Devam Ediyor'; case 'completed': return 'Tamamlandı'; case 'cancelled': return 'İptal'; default: return status; } }
  String get faultTypeText { const map = {'çalışmıyor': 'Çalışmıyor', 'soğutmuyor': 'Soğutmuyor', 'ses_gurultu': 'Ses/Gurultu', 'tıkanıklık': 'Tıkanıklık', 'su_kacagi': 'Su Kacagi', 'kirik_hasarli': 'Kirik/Hasarli', 'kapanmıyor': 'Kapanmıyor', 'koku': 'Koku', 'yanmıyor': 'Yanmıyor', 'dusuk_basinc': 'Dusuk Basinc', 'diger': 'Diger'}; return map[faultType] ?? faultType ?? '-'; }
