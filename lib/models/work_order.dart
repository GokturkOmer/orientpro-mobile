class WorkOrder {
  ...
  String get statusText { switch (status) { case 'open': return 'Acik'; case 'assigned': return 'Atandi'; case 'in_progress': return 'Devam Ediyor'; case 'completed': return 'Tamamlandi'; case 'cancelled': return 'İptal'; default: return status; } }
