      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Text('Teknik sorularinizi sorun, canli veriler ve\ndokumanlar ile yanitlayalim', textAlign: TextAlign.center, style: TextStyle(color: Colors.grey[500], fontSize: 13)),
            const SizedBox(height: 32),
            Wrap(spacing: 8, runSpacing: 8, alignment: WrapAlignment.center, children: [
              _buildQuickAction(Icons.thermostat, 'Kazan basinci normal mi?'),
              _buildQuickAction(Icons.warning_amber, 'Aktif alarm var mi?'),
              _buildQuickAction(Icons.ac_unit, 'Chiller durumu nedir?'),
              _buildQuickAction(Icons.bolt, 'Enerji tuketimi nasil?'),
              _buildQuickAction(Icons.build, 'Son is emirleri neler?'),
              _buildQuickAction(Icons.description, 'Yuklu dokumanlar neler?'),
            ]),
