  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(padding: const EdgeInsets.all(16), children: [
        ...
        const SizedBox(height: 12),
        DropdownButtonFormField<String>(value: _faultType, decoration: const InputDecoration(labelText: 'Ariza Tipi', prefixIcon: Icon(Icons.report_problem), border: OutlineInputBorder()), items: _faultTypes.map((f) => DropdownMenuItem(value: f['value'], child: Text(f['label']!))).toList(), onChanged: (v) => setState(() => _faultType = v!)),
        const SizedBox(height: 12),
